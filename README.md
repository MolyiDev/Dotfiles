...
These are my personalized dotfiles for **Hyprland**/**Niri**/**Sway**/**bspwm**, optimized for performance and simplicity with focus on the terminal.
...
## Selected Packages [hypr/niri/sway/bspwm]

```text
7zip                        # Compressor.
alacritty                   # Terminal emulator.
awatcher-bundle             # Activity and idle watcher.
